...
public class SearchableSpinner extends androidx.appcompat.widget.AppCompatSpinner implements View.OnTouchListener,
        com.techface.srimurugapa.scheme.Helper.SearchableListDialog.SearchableItem {

    public static final int NO_ITEM_SELECTED = -1;
    private Context _context;
    private List _items;
    private com.techface.srimurugapa.scheme.Helper.SearchableListDialog _searchableListDialog;
    ...
    public SearchableSpinner(Context context, AttributeSet attrs) {
        super(context, attrs);
        this._context = context;
        TypedArray a = context.obtainStyledAttributes(attrs, new int[]{R.layout.spinnertext});
    ...
    private void init() {
        ...
        _searchableListDialog = com.techface.srimurugapa.scheme.Helper.SearchableListDialog.newInstance(_items);
        _searchableListDialog.setOnSearchableItemClickListener(this);
        setOnTouchListener(this);
        _arrayAdapter = (ArrayAdapter) getAdapter();
        if (!TextUtils.isEmpty(_strHintText)) {
            ArrayAdapter arrayAdapter = new ArrayAdapter(_context, R.layout.spinnertext, new String[]{_strHintText});
            _isFromInit = true;
    ...
    public void setOnSearchTextChangedListener(SearchableListDialog.OnSearchTextChanged onSearchTextChanged) {
        _searchableListDialog.setOnSearchTextChangedListener((com.techface.srimurugapa.scheme.Helper.SearchableListDialog.OnSearchTextChanged) onSearchTextChanged);
    }
