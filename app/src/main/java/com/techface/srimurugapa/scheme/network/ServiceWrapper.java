...
import com.techface.srimurugapa.scheme.BuildConfig;
...
//            HttpLoggingInterceptor loggingInterceptor = new HttpLoggingInterceptor();
        ...
        Retrofit retrofit = new Retrofit.Builder()
                .baseUrl("http://bill.murugappasstores.com/murugappasapi/")
               // .baseUrl("http://192.168.43.173/paytmallinone_init_transaction/")
