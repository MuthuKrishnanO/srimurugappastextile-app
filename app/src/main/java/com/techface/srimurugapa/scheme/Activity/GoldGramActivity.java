...
public class GoldGramActivity extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_gold_gram);
        ...
        mGold22k.setText(String.valueOf(" :  "+gold22k+" gram"));
        mGold24k.setText(String.valueOf(" :  "+gold24k+" gram"));
        ...
        mDownload.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View view) {
                ...
                if (checker.lacksPermissions(PermissionChecker.REQUIRED_PERMISSION)) {
                    PermissionsActivity.startActivityForResult(GoldGramActivity.this, PERMISSION_REQUEST_CODE, PermissionChecker.REQUIRED_PERMISSION);
                } else {


                    createPdf(FileUtils.getAppPath(GoldGramActivity.this) + "TechFace.pdf");
        ...
        checker = new PermissionChecker(GoldGramActivity.this);
    ...
    private void loadBillDetails() {
        ...
        Call<List<billscheme>> call=service.getGOldGram(UserID);
        ...
        call.enqueue(new Callback<List<billscheme>>() {
            ...
            public void onFailure(Call<List<billscheme>> call, Throwable t) {
                mProgressdialog.cancel();
                if(GoldGramActivity.this !=null) {
                    mInfo = Responseinfodialog.alertshow(GoldGramActivity.this, "NO SCHEME REGISTER OR CONTECTION FAILED", Color.RED);
                    mInfo.show();
    ...
    private void loadtable(String mParam1) {
        ...
        ApiClient service = ServiceGenerator.createService(ApiClient.class);
        Call<List<Schemeinfo>> call=service.getGramSchemeInfo(mParam1,UserID);
        ...
        call.enqueue(new Callback<List<Schemeinfo>>() {
            ...
            public void onFailure(Call<List<Schemeinfo>> call, Throwable t) {
                ...
                mInfo = Responseinfodialog.alertshow(GoldGramActivity.this, "", Color.RED);
                mInfo.show();
                t.printStackTrace();
    ...
    public void createPdf(String dest) {
        ...
        /*    PdfPCell[] cells = pdfPTable.getRow(0).getCells();
            ...
            Toast.makeText(GoldGramActivity.this, "No application found to open this file.", Toast.LENGTH_SHORT).show();
        }
    }
