...
public class BillingActivity extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        loadBillDetails();
        addHeaders1();
        mTodalview.setText(String.valueOf("₹"+TotalAmount));
        ...
        mDownload.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View view) {
                ...
                if (checker.lacksPermissions(PermissionChecker.REQUIRED_PERMISSION)) {
                    PermissionsActivity.startActivityForResult(BillingActivity.this, PERMISSION_REQUEST_CODE, PermissionChecker.REQUIRED_PERMISSION);
                } else {

//getFilesDir().getAbsolutePath()+"/TechFace.pd
                    createPdf(FileUtils.getAppPath(BillingActivity.this)+"TechFace.pdf");
                    Log.i("filepath",FileUtils.getAppPath(BillingActivity.this)+"TechFace.pdf");
        ...
        checker = new PermissionChecker(BillingActivity.this);
    ...
    private void loadBillDetails() {
        ...
        Call<List<billscheme>> call=service.getBillNew(UserID);
        ...
        call.enqueue(new Callback<List<billscheme>>() {
            ...
            public void onFailure(Call<List<billscheme>> call, Throwable t) {
                mProgressdialog.cancel();
                if(BillingActivity.this !=null) {
                    mInfo = Responseinfodialog.alertshow(BillingActivity.this, "NO SCHEME REGISTER OR CONTECTION FAILED", Color.RED);
                    mInfo.show();
    ...
    private void loadtable(String mParam1) {
        ...
        ApiClient service = ServiceGenerator.createService(ApiClient.class);
        Call<List<Schemeinfo>> call=service.getSchemeInfoNew(mParam1,UserID);
        ...
        call.enqueue(new Callback<List<Schemeinfo>>() {
            ...
            public void onFailure(Call<List<Schemeinfo>> call, Throwable t) {
                ...
                mInfo = Responseinfodialog.alertshow(BillingActivity.this, "", Color.RED);
                mInfo.show();
                t.printStackTrace();
    ...
    public void createPdf(String dest) {
        ...
        try {
            ...
            Drawable d = getResources().getDrawable(R.mipmap.ic_murugapa_round);
            ...
            Paragraph para = new Paragraph("  BILL ", font1);
          ...
          //  pdfPTableheader.addCell(pdfCell3);
            ...
            pdfPTable.setWidths(new int[]{10,30, 40, 30, 30});
            ...
            PdfPCell pdfCell1 = new PdfPCell(getCellnewColor(" PayedDate"));
...
//                Log.i("mResponseList",mResponseList.get(i).getmSno());
            ...
            document.add(new Paragraph(""));
            document.close();
            Toast.makeText(BillingActivity.this, "Downloaded... :)", Toast.LENGTH_SHORT).show();
            FileUtils.openFile(BillingActivity.this, new File(dest));

        } catch (IOException | DocumentException ie) {

            Log.i("createPdf: Error ", ie.getLocalizedMessage());
        } catch (ActivityNotFoundException ae) {
            Toast.makeText(BillingActivity.this, "No application found to open this file.", Toast.LENGTH_SHORT).show();
        }
    }
