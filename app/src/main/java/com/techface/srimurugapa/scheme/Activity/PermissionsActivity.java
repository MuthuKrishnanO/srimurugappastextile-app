...
public class PermissionsActivity extends AppCompatActivity {
    ...
    private static final String EXTRA_PERMISSIONS = "com.techface.gold.scheme.EXTRA_PERMISSIONS";
    private static final String PACKAGE_URL_SCHEME = "package:";

    private PermissionChecker checker;
    private boolean requiresCheck;

    public static void startActivityForResult(@NonNull Activity activity, Object requestCode, String... permissions) {
